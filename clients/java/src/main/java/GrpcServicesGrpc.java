...
public final class GrpcServicesGrpc {
      ...
      synchronized (GrpcServicesGrpc.class) {
        if ((getPatchHelloMethod = GrpcServicesGrpc.getPatchHelloMethod) == null) {
          GrpcServicesGrpc.getPatchHelloMethod = getPatchHelloMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Services.HelloResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GrpcServicesMethodDescriptorSupplier("PatchHello"))
              .build();
        }
      }
    }
      ...
      synchronized (GrpcServicesGrpc.class) {
        if ((getPatchHelloSecureMethod = GrpcServicesGrpc.getPatchHelloSecureMethod) == null) {
          GrpcServicesGrpc.getPatchHelloSecureMethod = getPatchHelloSecureMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Services.HelloResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GrpcServicesMethodDescriptorSupplier("PatchHelloSecure"))
              .build();
        }
      }
    }
  ...
  private static final int METHODID_PATCH_HELLO = 16;
  private static final int METHODID_GET_HELLO_SECURE = 17;
  private static final int METHODID_POST_HELLO_SECURE = 18;
  private static final int METHODID_PUT_HELLO_SECURE = 19;
  private static final int METHODID_DELETE_HELLO_SECURE = 20;
  private static final int METHODID_PATCH_HELLO_SECURE = 21;
  private static final int METHODID_PUT_REGISTER = 22;
  private static final int METHODID_POST_REGISTER = 23;
  private static final int METHODID_POST_RESET_TODOS = 24;
  private static final int METHODID_SERVER_STREAM_FILES = 25;
  private static final int METHODID_SERVER_STREAM_SERVER_EVENTS = 26;
  private static final int METHODID_POST_UN_ASSIGN_ROLES = 27;
  private static final int METHODID_PUT_UPDATE_TODO = 28;
